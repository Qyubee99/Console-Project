	...
	class Program
	{
		static void Main()
		{
			...
			HSJ[] hsjs = new HSJ[]
			{
				...
				new HSJ(){Id = 2, Name = "+1 쓸만한 홍성재", Weight = 100, strengthenedPrice = 300, sellingPrice = 1000},
				...
				new HSJ(){Id = 15, Name = "+14 친일파 홍성재", Weight = 45, strengthenedPrice = 100000, sellingPrice = 3000000},
				new HSJ(){Id = 16, Name = "+15 국군 홍성재", Weight = 40, strengthenedPrice = 180000, sellingPrice = 7500000},
				new HSJ(){Id = 17, Name = "+16 원한을 품은 홍성재", Weight = 35, strengthenedPrice = 300000, sellingPrice = 14200000},
				new HSJ(){Id = 18, Name = "+17 깨달은 홍성재", Weight = 30, strengthenedPrice = 300000, sellingPrice = 20000000},
